        ...
        <div id="app">
                        <div class="form w3-col s12 m12 l12">
                                <datalist id = "descriptioinList">
                                    <option value="Tithe">
                                    <option value="Balance B/F">
                                    <option value="First Fruit">
                                    <option value="Sunday Collection">
                                    <option value="Project Collection">
                                    <option value="Midweek Collection">
                                    <option value="Diocesan Collection">
                                    <option value="Church of Nigeria Collection">
                                    <option value="Thanksgiving">
                                    <option value="Secret Offering">
                                    <option value="New Month Prophetic Offering">
                                    <option value="Holy Communion">
                                    <option value="Sale of Forms">
                                    <option value="Children's Collection">
                                    <option value="Harvest Debt">
                                    <option value="Covenant Renewal">
                                    <option value="Covenant Card">
                                    <option value="Stewardship Card">
                                </datalist>
                                <form id="inc" autocomplete="off"> 
                                        <h3 class = "w3-text-deep-purple"> Income</h3>
                                    <input  type="date" name = "transdate" class = "w3-input w3-border-green w3-round-large w3-border">
                                    <input List = "descriptioinList" type="text" name = "income" class = "w3-input w3-border-green w3-round-large w3-border" placeholder = "Description" required v-model = "description" @input = 'oninp'>
