                            ...
                            $user = new Users;
                                        if(isset($_POST['edit'])){
                                            ...
                                            echo  "<form action = '../register.php' method = 'POST' enctype='multipart/form-data' autocomplete='off'> 
                                                    <h5 class = 'w3-text-deep-purple w3-center'>Are you sure you want to delete this member?</h5>
                                                    <input  type='hidden' name = 'id' value = '$id' class = 'w3-input w3-border-green w3-round-large w3-border' required>
                                                    <input name = 'yes' Value = 'Yes' type = 'submit' class = 'w3-button w3-green w3-round-large w3-hover-deep-purple but'> &emsp; &emsp;
